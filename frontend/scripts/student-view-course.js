        ...
        try {
            ...
            if (course.enrolled) {
                ...
                joinBtn.onclick = async () => {
                    joinBtn.disabled = true;
                    try {
                        const joinResponse = await fetch(`http://localhost:8081/api/student/courses/${courseId}/join`, {
                            method: 'POST',
                            headers: {
                        ...
                        // Re-fetch course to ensure enrollment updated
                        await fetchCourse();
                        // Optionally navigate after 300ms to ensure DB persistence
                        setTimeout(() => {
